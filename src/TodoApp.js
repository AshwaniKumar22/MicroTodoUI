...
const GET_TASKS_API_BASE_URL = "http://get-tasks-api.devopsai.online";
const DELETE_TASK_API_BASE_URL = "http://delete-tasks-api.devopsai.online";
const CREATE_TASK_API_BASE_URL = "http://add-tasks-api.devopsai.online";
